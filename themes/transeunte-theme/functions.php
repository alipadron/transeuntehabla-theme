...
function same_template_for_evento_and_contenido( $template ) {
	// your custom post types.
	$my_types = array( 'evento', 'contenido' );
	...
	if ( is_singular( $my_types ) ) {
		...
		return get_stylesheet_directory() . '/single-contenido&evento.php';
	}
	return $template;
}
add_filter( 'template_include', 'same_template_for_evento_and_contenido' );
